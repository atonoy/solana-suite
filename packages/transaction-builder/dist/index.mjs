    ...
    submit = async (options = {}) => {
      return Try(async () => {
        ...
        try {
          ...
          if (TransactionBuilder4.RetryComputeUnit.isError(error)) {
            return await TransactionBuilder4.RetryComputeUnit.submit(
              transaction,
              finalSigners,
              confirmOptions
            );
    ...
    submit = async (options = {}) => {
      return Try(async () => {
        ...
        try {
          ...
          if (TransactionBuilder4.RetryComputeUnit.isError(error)) {
            return await TransactionBuilder4.RetryComputeUnit.submitForPartialSign(
              transaction,
