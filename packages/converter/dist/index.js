  ...
  ((CompressedNftMetadata2) => {
    CompressedNftMetadata2.intoInfra = (input, uri, sellerFeeBasisPoints) => {
      return {
        ...
        editionNonce: 0,
        tokenStandard: import_mpl_bubblegum_instructions.TokenStandard.NonFungible,
        tokenProgramVersion: import_mpl_bubblegum_instructions.TokenProgramVersion.Original
      };
    };
...
((Account5) => {
  ...
  ((Pda2) => {
    ...
    Pda2.getTreeAuthority = (address) => {
      const [publicKey] = import_web34.PublicKey.findProgramAddressSync(
        [address.toPublicKey().toBuffer()],
        import_mpl_bubblegum_instructions2.PROGRAM_ADDRESS.toPublicKey()
      );
      return publicKey;
    };
    Pda2.getBgumSigner = () => {
